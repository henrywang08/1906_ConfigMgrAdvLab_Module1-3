...
Click Next > to advance to the next exercise
===
#Module 1, Lab 2, Exercise 3 - (OPTIONAL) Configuring Device Writeback and Hybrid Azure AD Join

##Scenario
In this exercise you will: 
- Ensure Device Writeback and Hybrid Azure AD join are Enabled.

> [!KNOWLEDGE] If your environment has an on-premises AD footprint and you want the benefits of Azure AD, you can implement *hybrid Azure AD* joined devices. These devices are joined both to your on-premises Active Directory, and your Azure Active Directory.
...
1. [] Open Azure AD Connect configuration and click Configure
!IMAGE[Screenshot](Screens/fnulkur4.jpg)
1. [] At Additional Tasks select **Configure Device Options** and click **Next**
!IMAGE[Screenshot](Screens/yimfa355.jpg)
1. [] At Overview click **Next**
!IMAGE[Screenshot](Screens/wjfpcsc5.jpg)
1. [] At Connect to Azure AD, specify your global admin account for Office365 (this is the same account you have been using so far to access Azure) and click **Next**
!IMAGE[Screenshot](Screens/oumrxis5.jpg)
1. [] At Device Options select **Configure device writeback** and click **Next**
!IMAGE[Screenshot](Screens/kten0zxf.jpg)
1. [] At Writeback Forest select **contoso.com** for both *Device writeback forest* and *Device writeback location* and click **Next**
!IMAGE[Capture3.PNG](Capture3.PNG)
1. [] At Device container select **I will provide Enterprise Admin credentials** and enter +++Contoso\administrator+++ and +++Pa$$w0rd+++ and click **Next**
!IMAGE[Capture4.PNG](Capture4.PNG)
1. [] At Ready to Configure, click **Configure**
!IMAGE[Screenshot](Screens/woup1o5g.jpg)
1. [] At Configuration complete, click **Exit**
> [!KNOWLEDGE] Device Writeback should be working properly now, if you want to have more information on what to check to confirm that it is working please visit https://docs.microsoft.com/en-us/azure/active-directory/connect/active-directory-aadconnect-feature-device-writeback

10. [] Open *Server Manager* > Manage > Add Roles and Features
!IMAGE[qnxrzrqi.jpg](qnxrzrqi.jpg)
and click **Next** 4 times
1. [] At *Features* expand > Remote Server Administration Tools > Role Administration Tools > AD DS and AD LDS Tools and select **Active Directory module for Windows PowerShell**
!IMAGE[862emznm.jpg](862emznm.jpg)
and click **Next**, then click **Install**
!IMAGE[3sj7jnto.jpg](3sj7jnto.jpg)
1. [] Wait for the installation to finish then click **Close**
!IMAGE[pmyvposy.jpg](pmyvposy.jpg)
1. [] Right-click start and select Command Prompt (Admin)
!IMAGE[aug2acow.jpg](aug2acow.jpg)
1. [] Type +++powershell+++
1. [] Type +++Install-Module MSOnline+++
1. [] At *NuGet provider is required to continue* select +++Y+++ when prompted and press Enter
1. [] At *Untrusted repository* select +++Y+++ when prompted and press Enter
!IMAGE[mtbtpil9.jpg](mtbtpil9.jpg)
1. [] Type +++Import-Module -Name "C:\Program Files\Microsoft Azure Active Directory Connect\AdPrep\AdSyncPrep.psm1"+++
1. [] Type +++$CN = Get-ADRootDSE+++ and press Enter
1. [] Type +++$CN.configurationNamingContext+++ and press Enter
1. [] Type +++$scp = New-Object System.DirectoryServices.DirectoryEntry+++ and press Enter
1. [] Type +++$scp.Path = "LDAP://CN=62a0ff2e-97b9-4513-943f-0d221bd30080,CN=Device Registration Configuration,CN=Services," + $CN.configurationNamingContext+++ and press Enter
1. [] Type +++$scp.Keywords+++ and press Enter
>[!NOTE] The Service Connector Point has not been enabled yet, so the result of the last PowerShell command is an empty line

24. [] Open Azure AD Connect configuration and click **Configure**
1. [] At Additional Tasks select **Configure Device Options** and click **Next**
1. [] At Overview click **Next**
1. [] At Connect to Azure AD, specify your global admin account for Office365 (this is the same account you have been using so far to access Azure) and click **Next**
1. [] At Device Options select **Configure Hybrid Azure AD Join** and click **Next**
!IMAGE[708u8dw0.jpg](708u8dw0.jpg)
1. [] At SCP configuration select the checkbox near *contoso.com* and click **Add**
!IMAGE[zgs43zqs.jpg](zgs43zqs.jpg)
1. [] At *Enterprise Admin Credentials* type +++Contoso\administrator+++ and +++Pa$$w0rd+++, then click **OK** 
1. [] Change the Authentication Service from blank to Azure Active Directory 
!IMAGE[Capture5.PNG](Capture5.PNG)
and then click **Next**
1. [] At Device operating systems select *Windows 10 or later domain-joined devices*
!IMAGE[bzcgyumz.jpg](bzcgyumz.jpg)
and then click **Next**
1. [] At *Ready to configure* click **Configure**
!IMAGE[zom00joj.jpg](zom00joj.jpg)
1. [] At *Configuration complete*  click **Exit**
1. [] Go back to *Administrator Command Prompt - powershell* window and type +++$CN = Get-ADRootDSE+++ and press Enter
1. [] Type +++$CN.configurationNamingContext+++ and press Enter
1. [] Type +++$scp = New-Object System.DirectoryServices.DirectoryEntry+++ and press Enter
1. [] Type +++$scp.Path = "LDAP://CN=62a0ff2e-97b9-4513-943f-0d221bd30080,CN=Device Registration Configuration,CN=Services," + $CN.configurationNamingContext+++ and press Enter
1. [] Type +++$scp.Keywords+++ and press Enter
>[!NOTE] The SCP string is not empty anymore because it has been configured and it will look like the screenshot below
!IMAGE[uwtiusbe.jpg](uwtiusbe.jpg)

Congratulations! 
You have successfully:
- Configure Device Writeback and Hybrid Azure AD Join
